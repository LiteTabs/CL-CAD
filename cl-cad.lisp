...
(defun main-window ()
  (within-main-loop
   (let ((w (make-instance 'gtk-window :title "CL-CAD" :type :toplevel :window-position :center :default-width 1024 :default-height 600))
	 ...
	 (draw-area (make-instance 'drawing-area-test))
	 ;terminal
	 ...
	 (button-line (make-instance 'button :image (make-instance 'image :stock "gtk-dialog-question")))
	 (button-ray (make-instance 'button :image (make-instance 'image :stock "gtk-dialog-question")))
	 (button-construction (make-instance 'button :image (make-instance 'image :stock "gtk-dialog-question")))
	 (button-circle-radius (make-instance 'button :image (make-instance 'image :stock "gtk-dialog-question")))
	 (button-circle-2p (make-instance 'button :image (make-instance 'image :stock "gtk-dialog-question")))
	 (button-circle-3p (make-instance 'button :image (make-instance 'image :stock "gtk-dialog-question")))
	 (button-circle-diameter (make-instance 'button :image (make-instance 'image :stock "gtk-dialog-question")))
	 (button-circle-ttr (make-instance 'button :image (make-instance 'image :stock "gtk-dialog-question")))
	 (button-circle-ttt (make-instance 'button :image (make-instance 'image :stock "gtk-dialog-question")))
	 (button-arc (make-instance 'button :image (make-instance 'image :stock "gtk-dialog-question")))
	 (button-ellipse-center (make-instance 'button :image (make-instance 'image :stock "gtk-dialog-question")))
	 (button-ellipse-axis (make-instance 'button :image (make-instance 'image :stock "gtk-dialog-question")))
	 (button-ellipse-arc (make-instance 'button :image (make-instance 'image :stock "gtk-dialog-question")))
	 (button-pline (make-instance 'button :image (make-instance 'image :stock "gtk-dialog-question")))
	 (button-polygon (make-instance 'button :image (make-instance 'image :stock "gtk-dialog-question")))
	 (button-point (make-instance 'button :image (make-instance 'image :stock "gtk-dialog-question")))
	 (button-rectangle (make-instance 'button :image (make-instance 'image :stock "gtk-dialog-question")))
	 (button-spline (make-instance 'button :image (make-instance 'image :stock "gtk-dialog-question")))
	 (button-text (make-instance 'button :image (make-instance 'image :stock "gtk-dialog-question")))
         ;;;modify
	 ...
	 (button-break (make-instance 'button :image (make-instance 'image :stock "gtk-dialog-question")))
	 (button-edit-pline (make-instance 'button :image (make-instance 'image :stock "gtk-dialog-question")))
	 (button-edit-prop (make-instance 'button :image (make-instance 'image :stock "gtk-dialog-question")))
	 (button-edit-spline (make-instance 'button :image (make-instance 'image :stock "gtk-dialog-question")))
	 (button-edit-text (make-instance 'button :image (make-instance 'image :stock "gtk-dialog-question")))
	 (button-erase (make-instance 'button :image (make-instance 'image :stock "gtk-dialog-question")))
	 (button-explode (make-instance 'button :image (make-instance 'image :stock "gtk-dialog-question")))
	 (button-extend (make-instance 'button :image (make-instance 'image :stock "gtk-dialog-question")))
	 (button-lengthen (make-instance 'button :image (make-instance 'image :stock "gtk-dialog-question")))
	 (button-move (make-instance 'button :image (make-instance 'image :stock "gtk-dialog-question")))
	 (button-rotate (make-instance 'button :image (make-instance 'image :stock "gtk-dialog-question")))
	 (button-scale (make-instance 'button :image (make-instance 'image :stock "gtk-dialog-question")))
	 (button-stretch (make-instance 'button :image (make-instance 'image :stock "gtk-dialog-question")))
	 (button-trim (make-instance 'button :image (make-instance 'image :stock "gtk-dialog-question")))
         ;;;osnap
	 ...
	 (button-oscenter (make-instance 'button :image (make-instance 'image :stock "gtk-dialog-question")))
	 (button-osend (make-instance 'button :image (make-instance 'image :stock "gtk-dialog-question")))
	 (button-osins (make-instance 'button :image (make-instance 'image :stock "gtk-dialog-question")))
	 (button-osint (make-instance 'button :image (make-instance 'image :stock "gtk-dialog-question")))
	 (button-osmid (make-instance 'button :image (make-instance 'image :stock "gtk-dialog-question")))
	 (button-osnea (make-instance 'button :image (make-instance 'image :stock "gtk-dialog-question")))
	 (button-osnod (make-instance 'button :image (make-instance 'image :stock "gtk-dialog-question")))
	 (button-osnone (make-instance 'button :image (make-instance 'image :stock "gtk-dialog-question")))
	 (button-osper (make-instance 'button :image (make-instance 'image :stock "gtk-dialog-question")))
	 (button-osqua (make-instance 'button :image (make-instance 'image :stock "gtk-dialog-question")))
	 (button-ostan (make-instance 'button :image (make-instance 'image :stock "gtk-dialog-question")))
	 (button-ostrack (make-instance 'button :image (make-instance 'image :stock "gtk-dialog-question")))
         ;;;dimension
	 ...
	 (button-align (make-instance 'button :image (make-instance 'image :stock "gtk-dialog-question")))
	 (button-angular (make-instance 'button :image (make-instance 'image :stock "gtk-dialog-question")))
	 (button-baseline (make-instance 'button :image (make-instance 'image :stock "gtk-dialog-question")))
	 (button-center (make-instance 'button :image (make-instance 'image :stock "gtk-dialog-question")))
	 (button-continue (make-instance 'button :image (make-instance 'image :stock "gtk-dialog-question")))
	 (button-diameter (make-instance 'button :image (make-instance 'image :stock "gtk-dialog-question")))
	 (button-horiz (make-instance 'button :image (make-instance 'image :stock "gtk-dialog-question")))
	 (button-leader (make-instance 'button :image (make-instance 'image :stock "gtk-dialog-question")))
	 (button-vert (make-instance 'button :image (make-instance 'image :stock "gtk-dialog-question")))
	 ;;;zoom
     ...
     (table-attach modify-table button-edit-pline 1 2 0 1)
     (table-attach modify-table button-edit-prop 2 3 0 1)
     (table-attach modify-table button-edit-spline 3 4 0 1)
     (table-attach modify-table button-edit-text 0 1 1 2)
     (table-attach modify-table button-erase 1 2 1 2)
     (table-attach modify-table button-explode 2 3 1 2)
     (table-attach modify-table button-extend 3 4 1 2)
     (table-attach modify-table button-lengthen 0 1 2 3)
     (table-attach modify-table button-move 1 2 2 3)
     (table-attach modify-table button-rotate 2 3 2 3)
     (table-attach modify-table button-scale 3 4 2 3)
     (table-attach modify-table button-stretch 0 1 3 4)
     (table-attach modify-table button-trim 1 2 3 4)
     ;osnap
