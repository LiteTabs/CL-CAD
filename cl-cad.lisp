...
(defun osnap-window ()
  (within-main-loop
   (let ((window (make-instance 'gtk-window :type :toplevel :title "Osnap" :window-position :center :default-width 240 :default-height 320))
	 ...
	 (center-image (make-instance 'image :file (namestring (merge-pathnames "graphics/osnap/osnap_cen.png" *src-location*))))
	 (button-osend (make-instance 'check-button :label "End"))
	 (end-image (make-instance 'image :file (namestring (merge-pathnames "graphics/osnap/osnap_end.png" *src-location*))))
	 (button-osins (make-instance 'check-button :label "Insert"))
	 (ins-image (make-instance 'image :file (namestring (merge-pathnames "graphics/osnap/osnap_ins.png" *src-location*))))
	 (button-osint (make-instance 'check-button :label "Intersection"))
	 (int-image (make-instance 'image :file (namestring (merge-pathnames "graphics/osnap/osnap_int.png" *src-location*))))
	 (button-osmid (make-instance 'check-button :label "Midle"))
	 (mid-image (make-instance 'image :file (namestring (merge-pathnames "graphics/osnap/osnap_mid.png" *src-location*))))
	 (button-osnea (make-instance 'check-button :label "Nearest"))
	 (nea-image (make-instance 'image :file (namestring (merge-pathnames "graphics/osnap/osnap_nea.png" *src-location*))))
	 (button-osnod (make-instance 'check-button :label "Nod"))
	 (nod-image (make-instance 'image :file (namestring (merge-pathnames "graphics/osnap/osnap_nod.png" *src-location*))))
	 (button-osper (make-instance 'check-button :label "Perpendicular"))
	 (per-image (make-instance 'image :file (namestring (merge-pathnames "graphics/osnap/osnap_per.png" *src-location*))))
	 (button-osqua (make-instance 'check-button :label "Quadrant"))
	 (qua-image (make-instance 'image :file (namestring (merge-pathnames "graphics/osnap/osnap_qua.png" *src-location*))))
	 (button-ostan (make-instance 'check-button :label "Tangent"))
	 (tan-image (make-instance 'image :file (namestring (merge-pathnames "graphics/osnap/osnap_tan.png" *src-location*))))
	 (button-ostrack (make-instance 'check-button :label "track"))
	 (track-image (make-instance 'image :file (namestring (merge-pathnames "graphics/osnap/osnap_track.png" *src-location*))))
